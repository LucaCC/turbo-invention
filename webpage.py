...
def First_Page():
    with open('Primary_Elections_2016.json') as election_data:
        ...
        repColors = ["#37c732", "#43bfe6", "#4141f0", "#37c732", "#43bfe6", "#4141f0","#37c732", "#43bfe6", "#4141f0"]
        if 'candidate' in request.args:
            ...
            NumVote=get_party_vote("N/A", electionData), dDataPoints=get_cand_vote_data("Democrat", electionData),
            rDataPoints=get_cand_vote_data("Republican", electionData))
        else:
            return render_template('Political_Demographic_Dropdown.html', candidate=get_candidate_options(electionData),
            ...
            dDataPoints=get_cand_vote_data("Democrat", electionData, demColors), rDataPoints=get_cand_vote_data("Republican", electionData, repColors))
